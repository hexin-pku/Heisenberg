...
)
{
	...
	hermite(LL, effABx) * hermite(MM, effABy) * hermite(NN, effABz);
}
...
)
{
	...
	hermite(LL, effPCx) * hermite(MM, effPCy) * hermite(NN, effPCz); 
}
...
)
{
	...
	hermite(LL, effPQx) * hermite(MM, effPQy) * hermite(NN, effPQz); 
}
