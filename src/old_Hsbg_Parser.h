// Now, it has been substituted by Hsbg_Tasker.h
// please refer to Hsbg_Tasker.h
...
class Tasker
{
    ...
    //Task();
    Task(string myhiffile, string mylogfile)
    {
    ...
    */
    ...
    friend ostream &operator<<( ostream &output, Task &HT )
    {
        output << "========== task ID: ";
        output << HT.Title ;
        output << " ==========" << endl;
